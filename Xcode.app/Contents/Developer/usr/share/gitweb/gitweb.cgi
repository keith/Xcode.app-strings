...
our $version = "2.15.2 (Apple Git-101.1)";
...
our $GIT = "/Applications/Xcode.app/Contents/Developer/usr/bin/git";
...
return undef;
#'100644 blob 0fa3f3a66fb6a137f6ec2c19351ed4d807070ffa
panic.c'
...
gitweb'
#'100644 blob e02e90f0429be0d2a69b76571101f20b8f75530f
gitweb/README'
if ($line =~ m/(?:[0-9]+) (?:.+) $hash\t(.+)$/) {
close $fd;
return $1;
...
my $line = shift;
my %res;
# ':100644 100644 03b218260e99b78c6df0ed378e59ed9205ccc96d 3b93d5e7cc7f7dd4ebed13a5cc1a4ad976fc94d8 M
ls-files.c'
# ':100644 100644 7f9281985086971d3877aca27704f2aaf9c448ce bc190ebc71bbd923f2b728e505408f5e54bd073a M
rev-tree.c'
...
# '::100755 100755 100755 60e79ca1b01bc8b057abe17ddab484699a7f5fdb 94067cc5f73388f33722d52ae02f44692bc07490 94067cc5f73388f33722d52ae02f44692bc07490 MR
git-gui/git-gui.sh'
...
my %res;
if ($opts{'-l'}) {
#'100644 blob 0fa3f3a66fb6a137f6ec2c19351ed4d807070ffa   16717
panic.c'
...
print qq!
var tz_cookie = { name: '$tz_cookie', expires: 14, path: '/' };\n!. # in days
      qq!
onloadTZSetup('$jstimezone', tz_cookie, '$datetime_class');\n!;
print qq!};\n!.
      qq!</script>\n!;
print "</body>\n" .
      "</html>";
...
or die_error(500, "Open git-diff-tree failed");
@difftree =
# ':100644 100644 03b21826... 3b93d5e7... M
ls-files.c'
# $hash == to_id
